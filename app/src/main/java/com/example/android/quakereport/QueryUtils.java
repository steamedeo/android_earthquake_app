...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject converted = new JSONObject(SAMPLE_JSON_RESPONSE);

            JSONArray features = converted.getJSONArray("features");

//            Log.d("features array Stefano ", features.toString());
            ...
            for (int i = 0 ; i<features.length() ; i++){
                ...
                //create object
                Earthquake object = new Earthquake(mag, place, time, url);
